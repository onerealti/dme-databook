# Design Data Book — Screwed Joints: Design Manual & Standard Calculated Solutions

> [!NOTE]
> **Standard Engineering Design Data & Worked Calculation Manual:**  
> This design manual provides governing design equations, structural analysis procedures, thread specifications (IS: 4218 - 1976), technical figure diagrams, and fully evaluated design reference cases across all standard screwed joint configurations.

---

## Fastener Joint Classification & Design Index

| Mechanical Setup / Joint Configuration | Design Requirements | Data Book Section |
| :--- | :--- | :---: |
| Tap bolt / Known bolt size $d$ | Calculate safe tensile load $P$ or initial tightening stress $\sigma_t$ | **[Section 1](#section-1-standard-tensile-capacity-analysis-m-30-fasteners)** / **[Section 2](#section-2-initial-tightening-stress--preload-analysis-tap-bolts)** |
| Lifting Eye Bolt | Determine nominal diameter $d$ for axial load | **[Section 3](#section-3-lifting-eye-bolt-sizing--thread-selection)** |
| Flanged Shaft Coupling | Size coupling bolts under torsional shear torque $T$ | **[Section 4](#section-4-flanged-shaft-coupling-fastener-sizing-under-torsional-shear)** |
| Safety Valve Fulcrum Pin | Size threaded pin under lever equilibrium | **[Section 5](#section-5-safety-valve-fulcrum-pin-sizing--lever-equilibrium)** |
| Cylinder Cover Studs | Calculate stud count $n$, size $d$ & verify leak-proof pitch $p_c$ | **[Section 6](#section-6-cylinder-head-cover-stud-layout--leak-proof-pitch-verification)** |
| Pressure Vessel Cover Plate | Design shell thickness $t$, bolt count $n$ & cover plate $t_1$ | **[Section 7](#section-7-pressure-vessel-inspection-cover-plate--bolt-sizing)** |
| Preloaded Flange Gasket Joint | Size bolts with gasket factor $K$ via quadratic preload equation | **[Section 8](#section-8-preloaded-flange-fasteners-with-gasket-compression-soft-copper)** |
| Fatigue-Loaded Cylinder Studs | Size preloaded fasteners using Soderberg failure criterion | **[Section 9](#section-9-soderberg-fatigue--preload-design-criterion)** |
| Boiler Longitudinal Bar Stays | Size bar stays under boiler steam pressure | **[Section 10](#section-10-boiler-longitudinal-bar-stay-sizing)** |
| Turned Shank / Drilled Hole Bolt | Calculate axial hole diameter $D_h$ for uniform strength | **[Section 11](#section-11-turned-shank--drilled-hole-bolts-of-uniform-strength)** |
| Wall Bracket (Parallel Load) | Size bolts for wall bracket tilting about lower base edge | **[Section 12](#section-12-wall-brackets-under-parallel-eccentric-tensile-loading)** |
| Crane Runway T-Bracket | Calculate arm section stresses & fastening bolt stress | **[Section 13](#section-13-crane-runway-t-bracket-stress-analysis--fastening-bolts)** |
| Travelling Crane Bracket | Size bolts (combined shear & tension) & rectangular arm $t$ | **[Section 14](#section-14-travelling-crane-bracket-sizing-combined-shear--tension)** |
| Inclined Load Bracket | Size bolts (principal stress) & rectangular arm thickness $t$ | **[Section 15](#section-15-inclined-load-bracket-fastener-sizing--arm-thickness-analysis)** |
| Offset I-Section Bracket | Size bolts & I-section arm dimensions ($b = 3t$) | **[Section 16](#section-16-offset-i-section-bracket-under-inclined-loading)** |
| Pillar Crane Base (8-Bolt PCD) | Determine PCD bolt size under overturning moment | **[Section 17](#section-17-pillar-crane-circular-base-foundation-flange-sizing)** |
| Flanged Bearing Base | Size 4 PCD bolts for flanged bearing foundation | **[Section 18](#section-18-circular-flanged-bearing-base-fastener-sizing)** |
| Pillar Crane 2-Line Overturning | Determine max load distance $e$ & induced stress along Y-Y | **[Section 19](#section-19-pillar-crane-circular-foundation-2-line-overturning-analysis)** |
| Solid Forged Bracket | Size arm dia $D$ (bending+torsion), $d$ (bending) & bolt shear | **[Section 20](#section-20-solid-forged-bracket-under-combined-bending-torsion--coplanar-shear)** |
...
![Fig 11.23: Lifting Eye Bolt](Figures/fig%2011.23.png)
...
![Fig 11.27: Steam Engine Cylinder Head & Cover Stud Layout](Figures/fig%2011.27.png)
...
![Fig 11.48: Bolt of Uniform Strength with Central Drilled Axial Hole](Figures/fig%2011.48.png)
![Fig 11.49 & 11.50: Resilience and Energy Absorption in Bolts under Impact Loading](Figures/fig%2011.49%20%26%2011.50.png)
